...
export class ProductEdit implements IRouteViewModel  {
    ...
    private service: BaseService<IProduct> =
        ...
        new BaseService<ICounty>("https://localhost:5001/api/v1/Counties", this.httpClient, this.state.token);
        ...
        new BaseService<ICategory>("https://localhost:5001/api/v1/Categories", this.httpClient, this.state.token);
