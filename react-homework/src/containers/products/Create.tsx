...
const ProductCreate = () => {
    ...
    const [editData, setProduct] = useState({
        description: '', color: '', productAge: 0, isBooked: false,
        hasTransport: false, height: 0, width: 0, depth: 0, unit: '', county: '', city: '', category: '', condition: '', locationDescription: ''
    });
    ...
    const loadData = useCallback(async () => {
        ...
        let categoryResult = await BaseService.getAll<IUnit>('/Categories', appState.token!);
                    ...
                    <div className="col-md-6">
                        <section>
                            ...
                            <div className="form-group">
                                ...
                                <input value={editData.height} onChange={e => setProduct({ ...editData, height: e.target.valueAsNumber })} className="form-control" min={0} type="number" id="Input_ProductHeight" name="Input.ProductAge" autoComplete="current-name" />
                            </div>
                            <div className="form-group">
                                <label>{appState.langResources.bllAppDTO.products.width}</label>
                                <input value={editData.width} onChange={e => setProduct({ ...editData, width: e.target.valueAsNumber })} className="form-control" min={0} type="number" id="Input_ProductWidth" name="Input.ProductAge" autoComplete="current-name" />
                            </div>
                            <div className="form-group">
                                <label>{appState.langResources.bllAppDTO.products.depth}</label>
                                <input value={editData.depth} onChange={e => setProduct({ ...editData, depth: e.target.valueAsNumber })} className="form-control" min={0} type="number" id="Input_ProductDepth" name="Input.ProductAge" autoComplete="current-name" />
                            </div>
                            <div className="form-group">
